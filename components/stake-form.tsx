...
import { Loader2, TrendingUp, Lock, Zap } from "lucide-react"
      ...
      signAndExecute(
        { transaction: txBlock },
        {
          onSuccess: (result) => {
            toast({
              title: "Success!",
              description: `Staked successfully. Digest: ${result.digest}`,
            })
            setAmount("")
            setLoading(false)
          },
            ...
            {pools.map((pool) => (
              <Card
                ...
                className={`cursor-pointer transition-colors ${
                  selectedPool === pool.poolId ? "border-blue-500 bg-blue-500/5" : "hover:border-blue-500/50"
                }`}
