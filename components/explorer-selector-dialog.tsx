          ...
          {EXPLORERS.map((explorer) => {
            ...
            return (
              <button
                ...
                className="group relative flex flex-col gap-4 rounded-lg border border-border/50 bg-card/50 p-6 text-left transition-all hover:border-primary/50 hover:bg-primary/5 hover:shadow-lg hover:shadow-primary/10"
              >
                {isPreferred && (
