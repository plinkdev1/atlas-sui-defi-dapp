...
export function InfraDiscoveryContent() {
  ...
  const filterProviders = (providers: InfraService[], query: string, pricing: string | null): InfraService[] => {
    return providers.filter((provider: InfraService) => {
      const matchesSearch =
  ...
  const filteredRPCProviders = filterProviders(mockRPCProviders as unknown as InfraService[], searchQuery, selectedPricing) as unknown as RPCProvider[]
  const filteredGatewayProviders = filterProviders(mockGatewayProviders as unknown as InfraService[], searchQuery, selectedPricing) as unknown as GatewayProvider[]
            ...
            <>
              ...
              <Card className="glass-card border-blue-500/20 bg-blue-500/5">
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="bg-gray-900 dark:bg-gray-950 rounded p-3 text-xs font-mono text-gray-100 overflow-x-auto">
